...
for i, (y, title, ylabel) in enumerate(zip(
    ...
    ['Mean Spike Count Correlation vs. Day Number (V4E)', 'Dimensionality vs. Day Number (V4E)', 'Sparsity vs. Day Number (V4E)'],
...
plt.tight_layout()
plt.savefig('../plots/time_v4e.png')
#plt.show()
...
ax4.set_title('Sparsity vs. Dimensionality (V4E)')
ax4.set_xlabel('D(R)')
...
plt.tight_layout()
plt.savefig('../plots/D(C)vsD(R)_v4e.png')
#plt.show()
