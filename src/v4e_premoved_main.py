...
for i, (y, title, ylabel) in enumerate(zip(
    ...
    ['Mean Spike Count Correlation vs. Day Number (V4E-Premoved)', 'Dimensionality vs. Day Number (V4E-Premoved)', 'Sparsity vs. Day Number (V4E-Premoved)'],
...
plt.tight_layout()
plt.savefig('../plots/time_v4e_premoved.png')
#plt.show()
...
ax4.set_title('Sparsity vs. Dimensionality (V4E-Premoved)')
ax4.set_xlabel('D(R)')
...
plt.tight_layout()
plt.savefig('../plots/D(C)vsD(R)_v4e_premoved.png')
#plt.show()
...
ax.set_title('Greatest Eigenvalue over Days (V4E)')
...
plt.tight_layout()
plt.savefig('../plots/greatest_eigenvalue_over_day_v4e.png')
