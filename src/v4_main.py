...
for i, (y, title, ylabel) in enumerate(zip(
    ...
    ['Mean Spike Count Correlation vs. Day Number (V4)', 'Dimensionality vs. Day Number (V4)', 'Sparsity vs. Day Number (V4)'],
...
ax4.set_title('Sparsity vs. Dimensionality (V4)')
ax4.set_xlabel('D(R)')
...
plt.tight_layout()
plt.savefig('../plots/D(C)vsD(R)_v4.png')
#plt.show()
